...
import {HeureDetailsJobyerPage} from "../heure-details-jobyer/heure-details-jobyer";
import {ModalMissionJobyerPage} from "../modal-mission-jobyer/modal-mission-jobyer";
 ...
 */
@Component({
  templateUrl: 'mission-details-jobyer.html',
  selector: 'mission-details-jobyer'
})
export class MissionDetailsJobyerPage{
  ...
  gotoHourDetails(day, isStart) {
    let modal = this.modal.create(ModalMissionJobyerPage, {contract: this.contract, day: day, isStart: isStart});
    modal.present();
